...
#if (ADC_ADCSRA_PRESCALER_SELECT>ADCSRA_PRESCALER_8_DIVISION) || ((ADC_ADCSRA_PRESCALER_SELECT<ADCSRA_PRESCALER_2_DIVISION))
...
//	/*ENABLE  ADC */
	...
	//Auto trigger source ON,Conversion Complete Interrupt (Flag still works) is  off
